    ...
    <div class="container" style="margin-top: 80px;">
        <div class="row">
            <div class="col-md-12 my-3">
                ...
                <p>This privacy policy discloses the privacy practices for zionworkers.com.
                ...
                <p>We will use your information to respond to you, regarding the reason you contacted
                    ...
                    other than as necessary to fulfill your request, e.g. to notify you on new episodes.</p>
                ...
                <p>You may opt out of any future contacts from us at any time. You can do the
                    following at any time by contacting us via the email address given on our website:</p>
                <ul>
                ...
                <h3>Registration</h3>
                <p>In order to use this website, a user must first complete the registration form.
                    ...
                    products/services on our site in which you have expressed interest.</p>
                ...
                <p>If you feel that we are not abiding by this privacy policy, you should contact us
                    immediately via email at support@zionworkers.com.</p>
            </div>
        </div>
    </div>
@endsection
